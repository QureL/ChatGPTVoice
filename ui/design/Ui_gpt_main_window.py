...
class Ui_gpt_chat_widget(object):
    def setupUi(self, gpt_chat_widget):
        ...
        self.btn_gpt_setting = QPushButton(gpt_chat_widget)
        self.btn_gpt_setting.setObjectName(u"btn_gpt_setting")

        self.horizontalLayout_3.addWidget(self.btn_gpt_setting)
